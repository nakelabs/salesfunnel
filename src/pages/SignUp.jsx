                ...
                <div className="w-full max-w-md">
                    ...
                    {step === 1 && (
                        <form onSubmit={handleContinue} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="w-full py-4 bg-black text-white font-bold text-base border border-[#3b82f6] hover:bg-[#0d1a2d] tracking-widest uppercase transition-all mt-6"
                    ...
                    {step === 2 && (
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="button"
                                onClick={() => setStep(1)}
                                className="w-full py-4 mt-3 bg-transparent text-slate-700 border border-slate-300 hover:border-slate-400 font-bold text-sm tracking-widest uppercase transition-all"
                                style={{ clipPath: 'polygon(12px 0%, 100% 0%, 100% calc(100% - 12px), calc(100% - 12px) 100%, 0% 100%, 0% 12px)' }}
                            >
                                ← Back
                            </button>
